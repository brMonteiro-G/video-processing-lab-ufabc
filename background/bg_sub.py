...
def process_video(video_path, mode="fast"):
    ...
    output_path = f'./outputs/{mode}_output_video.avi'
...
process_video("output_video_from_web_cam_fast_motion.avi", mode="fast")
process_video("output_video_from_web_cam_slow_motion.avi", mode="slow")
